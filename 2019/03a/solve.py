...
for i in wire2:
	...
	for j in range(number):
		if matrix[currentx][currenty] == 1:
			crosses.append([currentx-startx,currenty-starty])
...
crosses.sort(key=getDist)

crosses = crosses[1:] #To remove the cross where both wires begin

print getDist(crosses[0])
